...
const DashboardUtility = () => {
  return (
    <article className="w-full md:w-1/5 h-full bg-black h-full w-full rounded-2xl text-white flex justify-between flex-col px-[60px] py-[50px]">
      <section className="">
          ...
          {DASHBOARD_OPTIONS.map((d) => {
            return (
              <span className="flex gap-5 items-center">
                ...
                />
                <p className="font-bold cursor-pointer">{d.option}</p>
              </span>
            );
          })}
        </div>
